 ...
 */
var getErrorMessage = exports.getErrorMessage = function (err) {
  console.log(chalk.green('Initial Error: ', JSON.stringify(err)));
  ...
  console.log(chalk.green.bold('Final Error Message: ', JSON.stringify(message)));
  return message;
};
 ...
 */
exports.errorResponse = function(err, res) {
